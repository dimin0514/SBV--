<template>
    <div class="login-form">
		<form>
			...
			<a href="">학년별 1등과 최하위 학생 topByGrade</a>
			<div class="form-group">
				<input v-model="searchWord" type="text" class="form-control" value='topByGrade' required="required">
			</div>
			<div class="form-group">
				...
				<a @click.prevent="groupingByHak">7. 단순 그룹화(학년별  그룹화)</a><br>
			</div>      
			<table class="table">
				<tr>
					<th>No.</th>
